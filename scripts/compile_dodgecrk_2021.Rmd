...
target.dir <- file.path(root.dir, "data", "2021", "dodge_creek")
...
```{r Import data}
sample.all <- read.csv(file.path(target.dir, "2021_chem_preqaqc_SAMPLE-dodge_creek_2021-09-20.csv"), stringsAsFactors = FALSE)
result.all <- read.csv(file.path(target.dir, "2021_chem_preqaqc_RESULT-dodge_creek_2021-09-20.csv"), stringsAsFactors = FALSE,
...
pcode <- read.csv(file.path(datamod.dir, "MASTER_S_CHEM_PARAMETER_2021-05-03.csv"), stringsAsFactors = FALSE, colClasses = "character") 
...
write.table(sample.all.FINAL, file = file.path("C:/Data/RIBS/QAQC/sections/data/projectData/Streams/2021/dodge_creek", "dodgecrk_2021_SAMPLE-chemQCd_DBformat_2021-09-20.csv"),sep=",", row.names = FALSE, na = "")
write.table(result.all.FINAL, file = file.path("C:/Data/RIBS/QAQC/sections/data/projectData/Streams/2021/dodge_creek", "dodgecrk_2021_RESULT-chemQCd_DBformat_2021-09-20.csv"),sep=",", row.names = FALSE, na = "")

```


```{r Create and update MASTER tables, eval = FALSE}
