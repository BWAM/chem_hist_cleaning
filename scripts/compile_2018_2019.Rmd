...
Convet NAs to text for not_null fields (for coded tables)
```{r}
...
write.table(result.all.FINAL, file = file.path(path, "20201023_S_CHEM_HISTORY_RESULT.csv"),sep=",", row.names = FALSE, na = "")
