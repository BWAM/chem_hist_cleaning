...
result.all.FINAL <- result.all.form %>% 
  select(CHEM_PCODE, CHR_SYS_SAMPLE_CDE, CHR_SAMPLE_DEL_GRP, CHR_LAB_ANAL_METHOD_NAME, CHR_ANALYSIS_DATE, CHR_FRACTION, CHR_TEST_TYPE, CHR_LAB_MATRIX_CDE, 
         ...
         CHR_RESULT_TYPE_CDE, CHR_REPORTABLE_RESULT_IND, CHR_DETECT_FLAG, CHR_QLFR_SRC, CHR_LAB_QUAL, CHR_INTERPRETED_QUAL, CHR_VALIDATED_IND, CHR_VALIDATOR_QUAL, 
...
write.table(result.all.FINAL, file = file.path(root.dir, "data", "2018-2019_ITS_2020-08-25", "S_CHEM_HISTORY_RESULT.csv"),sep=",", row.names = FALSE, na = "")
