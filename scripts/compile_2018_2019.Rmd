...
sample.all.form <- sample.all %>%
  ...
  mutate(SAMPLE_DATE = strftime(SAMPLE_DATETIME.posixct, "%m/%d/%Y")) %>%
...
write.table(sample.all.FINAL, file = file.path(root.dir, "data", "2018-2019_ITS_2020-08-25", "S_CHEM_HISTORY_SAMPLE.csv"),sep=",", row.names = FALSE, na = "")
...
write.table(batch.all.FINAL, file = file.path(root.dir, "data", "2018-2019_ITS_2020-08-25", "S_CHEM_HISTORY_BATCH.csv"),sep=",", row.names = FALSE, na = "")
