...
```{r}
pcode.draft.input <- readxl::read_excel(file.path(root.dir, "parameters", "pcode_table_FINAL_CODES_2020-08-28.xlsx")) 
...
write.table(pcode.final, file = file.path(root.dir, "data", "2018-2019_ITS_2020-08-25", "S_CHEM_PARAMETER.csv"),sep=",", row.names = FALSE,  na = "")
