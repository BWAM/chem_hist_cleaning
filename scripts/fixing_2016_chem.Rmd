...
###################
###################
##### DO NOT USE bound 2016 result and sample files referenced below! Need to join each EDD individually to properly relate #####
        ## Use process in C:\Data\RIBS\Chem_raw_processing\data_output\2016\RIBS_EDD_processing_2016_forhistoricDB.Rmd
        ##      that creates "RIBSdata" data frame; not separate sample and result dataframes.
###################
###################
...
# Final soltion: Do left join of results table to sample table (only retaining rows from results). Need to make sure there are no unique sample dates for duplicated sys_sample_codes.
