...
#   filter(n()>1)
        #found that one set of dups was simplified to a single SBU ID exists
...
## Temporary block - Join and export data for fulfilling data requests in the meantime until data is fully cleaned ## 
```{r}
...
Subsetting for Tin Brook request
```{r}
